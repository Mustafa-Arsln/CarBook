...
namespace CarBook.WebUI.ViewComponents.DefaultViewComponents
{
    public class _DefaultStatisticsComponentPartial:ViewComponent
    {
        ...
        {     var client = _httpClientFactory.CreateClient();
            ...
            #endregion
            #region İstatistik3 
            var responseMessage3 = await client.GetAsync("https://localhost:7081/api/Statistics/GetBrandCount");
            ...
            #endregion
            #region İstatistik4
            var responseMessage4 = await client.GetAsync("https://localhost:7081/api/Statistics/GetCarCountByFuelElectric");
